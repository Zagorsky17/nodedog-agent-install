...
check_log_present() {
    ...
    warn "Обычно причин две, и проверить нужно обе:"
    warn "  1. Access-лог не включён в конфигурации Xray. Включается он"
    ...
    warn "  2. Каталог не проброшен на хост. В docker-compose.yml ноды:"
    warn "         volumes:"
